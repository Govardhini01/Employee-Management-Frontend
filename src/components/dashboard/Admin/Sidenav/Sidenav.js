...
import { AccountCircleOutlined, LockReset, ListAlt, AddCircleOutline } from '@mui/icons-material';
import { List, ListItemButton, ListItemIcon, ListItemText } from '@mui/material';
import './Sidenav.css';

const Sidenav = ({ selectedIndex, setSelectedIndex}) => {
    const menuList = [
        {key: "employeeList", label: "Employee List", icon: <ListAlt />, selected: false},
        {key: "createEmployee", label: "Create Employee", icon: <AddCircleOutline />, selected: false},
